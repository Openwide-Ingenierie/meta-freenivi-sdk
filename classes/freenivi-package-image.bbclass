...
EOF
    ...
    cp ${DEPLOY_DIR_IMAGE}/${IMAGE_PACKAGE_SDCARD} ${INSTALLER_PACKAGE_DEPLOY_DIRECTORY}/${INSTALLER_PACKAGE_NAME}/data/SDK/${FREENIVI_SDK_TARGET}/images/${FREENIVI_IMAGE_NAME}/
}
